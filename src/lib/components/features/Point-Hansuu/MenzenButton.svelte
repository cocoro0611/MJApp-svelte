<script lang="ts">
  ...
  const buttonConfig: { [key: string]: ButtonConfig } = {
    ...
    Btn12: { label: "海底　摸月", value: 1, group: "1翻役" },
    Btn13: { label: "河底　撈魚", value: 1, group: "1翻役" },
    Btn14: { label: "嶺上　開花", value: 1, group: "1翻役" },
    Btn15: { label: "槍槓", value: 1, group: "1翻役" },
    Btn16: { label: "ドラ", value: 1, group: "1翻役", isDora: true },
    // 2翻役
    Btn17: { label: "ダブル立直", value: 2, group: "2翻役" },
    Btn18: { label: "三色　同順", value: 2, group: "2翻役" },
    Btn19: { label: "三色　同刻", value: 2, group: "2翻役" },
    Btn20: { label: "三暗刻", value: 2, group: "2翻役" },
    Btn21: { label: "一気　通貫", value: 2, group: "2翻役" },
    ...
    Btn36: { label: "国士　無双", value: 13, group: "役満" },
    Btn37: { label: "九蓮　宝燈", value: 13, group: "役満" },
