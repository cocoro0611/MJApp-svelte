<script lang="ts">
  ...
  const buttonConfig: { [key: string]: ButtonConfig } = {
    ...
    Btn7: { label: "海底　摸月", value: 1, group: "1翻役" },
    Btn8: { label: "河底　撈魚", value: 1, group: "1翻役" },
    Btn9: { label: "嶺上　開花", value: 1, group: "1翻役" },
    Btn10: { label: "槍槓", value: 1, group: "1翻役" },
    Btn11: { label: "ドラ", value: 1, group: "1翻役", isDora: true },
    Btn12: { label: "三色　同順", value: 1, group: "1翻役" },
    Btn13: { label: "一気　通貫", value: 1, group: "1翻役" },
    Btn14: { label: "混全帯么九", value: 1, group: "1翻役" },
    // 2翻役
    Btn15: { label: "三色　同刻", value: 2, group: "2翻役" },
