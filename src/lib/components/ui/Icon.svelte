...
{#if type === "home"}
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    class="icon icon-tabler icons-tabler-outline icon-tabler-home iconSize"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
{#if type === "user"}
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    class="icon icon-tabler icons-tabler-outline icon-tabler-user iconSize"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
{#if type === "calculator"}
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    class="icon icon-tabler icons-tabler-outline icon-tabler-calculator iconSize"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <path
...
{#if type === "calculatorFilled"}
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    fill="currentColor"
    class="icon icon-tabler icons-tabler-filled icon-tabler-calculator iconSize"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <path
...
{#if type === "refresh"}
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    class="icon icon-tabler icons-tabler-outline icon-tabler-refresh text-white"
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
